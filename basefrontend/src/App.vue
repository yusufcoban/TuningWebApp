<template>
    <div class="auto-data">
        <div class="card" v-if="selectedModel == null">
            <div class="card-header border-0 pt-10 px-6 px-lg-10 px-xxl-15">
                <div class="card-title d-block w-100 m-0">
                    <h4 class="fs-1 text-gray-800 w-bolder mb-6">Select Vehicle Make</h4>
        ...
        <div v-if="tuningInfo && !isUploading && selectedModel == null" class="tuning-info mt-5">
...
<script>
    ...
    import AvailableSolutions from './components/AvailableSolutions.vue';
