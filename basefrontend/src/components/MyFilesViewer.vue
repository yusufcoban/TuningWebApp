    ...
    <div class="my-files-page">
        ...
        <div class="cards-container">
            ...
            <div v-if="dataFromBackend && dataFromBackend.length" v-for="file in dataFromBackend" :key="file.id" class="file-card">
                <h2>{{ file.title }}</h2>
                <p><strong>File Name:</strong> {{ file.fileName }} <button  type="button" class="btn btn-primary" @click="downloadFile(file.fileName)">Download</button></p>
                    ...
                    <ul>
                        <li v-for="task in file.tasks" :key="task.id">
                            ...
                            <p>
                                ...
                                <button type="button" class="btn btn-primary" @click="downloadFile(task.newFileName)">Download tuning file</button>
